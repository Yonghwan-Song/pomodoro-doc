...
<ReactPlayer playing={false} controls url={"https://youtu.be/X1ZtEBbwSik"} />
...
- 각 박스 바로 아래에 타임라인 중 짙은 색 부분을 클릭하면 그 박스만큼의 세션을 진행하는 데 걸린 시간과 그것의 시작과 끝을 확인할 수 있습니다.
  <ReactPlayer playing={false} controls url={"https://youtu.be/SSCE73TjEhY"} />
...
<ReactPlayer playing={false} controls url={"https://youtu.be/rA85ieG7GoI"} />
